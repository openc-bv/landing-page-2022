...
<Prose>
	...
	<!--<h2>Solution</h2>-->
	<p>OpenC & company have a very long tradition of creating both robust insurance solutions while innovating continuously. OpenC & company take an academic approach to all newer technologies, such as artificial intelligence, machine learning, blockchain, crypto, non fungible tokens. One of the key questions is: how can relevant technologies benefit the operational and strategisch objectives of your insurance business? And perhaps even more important: if applying great new technologies seems needed, what should be the right timing?</p>
</Prose>
